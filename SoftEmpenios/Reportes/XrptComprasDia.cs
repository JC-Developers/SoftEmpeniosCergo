...
{
    public partial class XrptComprasDia : DevExpress.XtraReports.UI.XtraReport
    {
        private IQueryable<DetallesCompra> detalles = new EmpeñosDC(new clsConeccionDB().StringConn()).DetallesCompras
            .Where(d => d.Compra.FechaCompra.Date == DateTime.Today.Date && d.Compra.Estado);
        public XrptComprasDia()
        {
            InitializeComponent();
        }
